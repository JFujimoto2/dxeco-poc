...
外部SaaSとの比較分析を踏まえ、POCの説得力を高めるために追加すべき機能と、運用本番化に向けた課題を整理する。
...
**根拠:** `saas_contracts.expires_on` が既にあり、通知基盤（TeamsNotifier）も整備済み。外部SaaSにもある機能なので「同等以上」と言いやすい。
